 ...
 * @description：FinalShell的离线激活
 * @date ：2022/11/3 17:04
 */
@SpringBootTest
public class FinalShellTests {

    @Test
    public void finalShell() throws NoSuchAlgorithmException, IOException {
        System.out.println("请输入FinalShell的离线机器码");
